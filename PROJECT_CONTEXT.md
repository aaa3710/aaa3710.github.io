...
2026-09-07: 一覧・日英の全3アプリの共通案内・日本語改行を改修。指定セクションを削除し、WordPress編集への移行案を整理した。[改修と検証](website-refinement-2026-09-07.md)を参照。GitHub本番は今回未更新、WordPress管理画面・常駐同期は未導入。
