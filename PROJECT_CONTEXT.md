...
37/37テスト、format、lint、build、71経路・2019 assertions成功。Chromeで公開先所有者aaa3710を確認し、日英12ページを390/1440pxの24条件で検証、横はみ出し・iframeは0。代表画面を独立目視した。問い合わせ受付は準備中のまま。公開の実結果は配信完了後に追記する。
