...
3. `伝わる文字 / Tsutawaru Moji` は本体の確定公開原稿から日英の紹介・Support・Privacy・Feedbackをローカル整備する。今回の変更は未push・未公開で、実受付は無効。[ローカル検証と公開前条件](app-store/tsutawaru-moji/site-verification-2026-09-05.md)を参照する。
