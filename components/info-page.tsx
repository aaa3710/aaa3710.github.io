  ...
  ja: {
    privacy: {
      ...
      sections: [
        ...
        [
          'TestFlightの連絡先',
          'TestFlight参加者は、TestFlightのフィードバック機能をご利用ください。プライバシーの質問や法令上の請求は、TestFlightでこのアプリを開き、情報欄の「Appの詳細」に表示される開発者のメールアドレスへお送りください。',
        ],
        [
          '一般フィードバック',
    ...
    privacy: {
      ...
      sections: [
        ...
        [
          ...
          'TestFlight participants can use TestFlight’s feedback feature. For privacy questions or statutory requests, open this app’s page in TestFlight, select App Details in the Information section, and contact the developer at the email shown there.',
        ],
        [
          'General feedback',
          (formReadiness['app-feedback']
