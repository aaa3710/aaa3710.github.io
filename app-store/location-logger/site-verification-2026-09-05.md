...
- LocationLogger本体の公開原稿6本は今回変更されないため生成データを現commitのまま維持し、今後、実受付・AIの実態に合わせて6原稿が改訂された場合だけ再同期する。新しい6原稿の受領を今回の待ち条件にはせず、今回の変更は未公開Feedback案内と認知repo内の運用記録だけに限定する。
