...
日本語4枚・英語4枚は、Focus Mapの素材実装基準コミット`7ec79a1f906195bea31940fbbfdd321f24ca40b8`にあるDebug提出fixtureから再撮影済みです。AppleがiPhone 6.9インチ表示向けに受け付ける1320×2868pxのPNGとして、RGB／sRGB、アルファなし、8枚すべて異なるSHA-256であることを検査しました。現在のHEADは作業時にlive確認し、最新監査と照合します。
